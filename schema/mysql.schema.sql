...
CREATE TABLE tbl_user (
    ...
    ctime bigint unsigned DEFAULT NULL,
    mtime bigint unsigned DEFAULT NULL,
    UNIQUE uq_oidc_user_provider_name (provider_id, name) USING BTREE,
...
CREATE TABLE tbl_group (
    ...
    ctime bigint unsigned DEFAULT NULL,
    mtime bigint unsigned DEFAULT NULL,
    UNIQUE uq_oidc_group_name (provider_id, name) USING BTREE,
    FOREIGN KEY (provider_id)
       REFERENCES tbl_provider (id)
       ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE tbl_group_membership (
    ...
    ctime bigint unsigned DEFAULT NULL,
    mtime bigint unsigned DEFAULT NULL,
    CONSTRAINT fk_group_membership_provider
      FOREIGN KEY (provider_id)
          REFERENCES tbl_provider (id)
          ON DELETE CASCADE,
