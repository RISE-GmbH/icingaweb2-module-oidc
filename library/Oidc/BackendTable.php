...
class BackendTable extends BaseHtmlElement
{
    protected $tag = 'table';
        ...
        return [
            ...
            'id' => [
                ...
                'renderer' => function ($data) {
                    ...
                    $link1 = (new ButtonLink("", \ipl\Web\Url::fromPath('oidc/config/edituserbackend',['backend'=>$data]), 'eye'))
                        ->openInModal();

                    $link2 = (new ButtonLink("", \ipl\Web\Url::fromPath('oidc/config/removeuserbackend',['backend'=>$data]), 'trash'))
                        ->openInModal();
                    $div->add($link1);
                    $div->add($link2);
